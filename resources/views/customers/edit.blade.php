        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    @endif --}}
                    <form action="/customers/{{ $customer->id }}" method="POST" class="px-4">
                        @method('PUT')
                        @csrf
                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama</label>
                            <input name="name" type="text" class="form-control" id="nama"
                                aria-describedby="emailHelp" placeholder="Nama" value="{{ $customer->name }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="email" type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="emailHelp" placeholder="Email" value="{{ $customer->email }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="phone" type="text" class="form-control" id="exampleInputEmail1"
                                aria-describedby="phone" placeholder="Phone" value="{{ $customer->phone }}">
                            <div class="text-primary text-xs">
                                @if ($errors->has('phone'))
                                    {{ $errors->first('phone') }}
                                    <div class="icon text-primary ms-1">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="address" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                placeholder="Address" rows="3">{{ $customer->address }}</textarea>
                            <div class="text-primary text-xs">
