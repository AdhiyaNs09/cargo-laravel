        ...
        <div class="row mt-4">
                ...
                <div class="card z-index-2">
                    <div class="card-body p-3">
                        <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                            <div class="chart">
                                <canvas id="chart-bars" class="chart-canvas" height="170" width="378"
                                    style="display: block; box-sizing: border-box; height: 170px; width: 378px;"></canvas>
                            </div>
                        </div>
            ...
            <div class="col-lg-7">
                <div class="card z-index-2">
                    ...
                    <div class="card-body p-3">
                        <div class="chart">
                            <canvas id="chart-line" class="chart-canvas" height="300" width="558"
                                style="display: block; box-sizing: border-box; height: 300px; width: 558px;"></canvas>
                        </div>
                    </div>
                </div>
            </div>
